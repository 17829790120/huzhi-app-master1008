    ...
    var placeHolderConverter = function(editor) {
        return function(nodes) {
            ...
            while (i--) {
                ...
                if (node.name === 'iframe' && hasLiveEmbeds(editor) && global$8.ceFalse) {
                ...
                } else if (node.name === 'video' && hasLiveEmbeds(editor) && global$8.ceFalse) {
                    ...
                    if (node.firstChild && node.firstChild.value) {
                        ...
                        console.log(Object.keys(elel))
                        console.log(Object.values(elel))
                        console.log(JSON.stringify(Object.entries(elel), null, 2))
                        // alert(JSON.parse($(node.firstChild.value)));
                        // alert(JSON.parse(elel));
