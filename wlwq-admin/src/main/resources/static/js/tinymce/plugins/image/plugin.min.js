...
! function() {
    "use strict";
    var t, e, n, r, o, a = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        c = function() {
        ...
        X = function(e) {
            var t, n, r, a;
            $(e) ? (a = (r = e).parentNode, j.insertAfter(r, a), j.remove(a)) : (t = e, n = j.create("figure", {
                "class": "image"
            }), j.insertAfter(n, t), n.appendChild(t), n.appendChild(j.create("figcaption", {
        ...
        fe = function(t, e) {
            var n = function(e, t) {
                ...
                if (ce(e, c(c({}, t), {
                        caption: !1
                    }), n), se(n, t.alt, t.isDecorative), t.caption) {
                    var r = j.create("figure", {
                        "class": "image"
                    });
                    return r.appendChild(n), r.appendChild(j.create("figcaption", {
                        contentEditable: "true"
        ...
        De = function(e, i) {
            ...
            return ve.each(e, function(e) {
                ...
                e.menu !== undefined ? (n = De(e.menu, i), o.push({
                    text: a,
                    items: n
                })) : (r = i(e), o.push({
                    text: a,
    ...
    var Ue = function(e) {
        ...
        je = function(h, b, v) {
            return function(e, t) {
                ...
                }), d.prevImage = p, ze(c, m, d, g)) : "alt" === t.name ? v.prevAlt = e.getData().alt : "style" === t.name ? (o = h, s = (l = e).getData(), u = He(o.parseStyle, o.serializeStyle, s), l.setData(u)) : "vspace" === t.name || "hspace" === t.name || "border" === t.name || "borderstyle" === t.name ? (n = h, r = e, a = be(Le(b.image), r.getData()), i = ie(n.normalizeCss, Ee(a, !1)), r.setData({
                    style: i
            ...
            return function(e) {
                ...
                return {
                    ...
                    body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? {
                        type: "tabpanel",
                        tabs: x([
                            [Ne(r)], r.hasAdvTab ? [Ue(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [_e(r)] : []
                        ])
                    } : {
                        type: "panel",
                        items: Pe(r)
