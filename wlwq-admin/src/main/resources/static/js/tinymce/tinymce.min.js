...
! function() {
    ...
    De = undefined, Oe = sr, Be = cr, Pe = undefined,
        function(e) {
                            ...
                            if (r) {
                                ...
                                if (o) {
                                    ...
                                    if (i) {
                                        ...
                                        if (a) {
                                            var u = [r, o, i, a];
                                            for (k = u.length - 1; k-- && u[k] === u[k + 1];); - 1 < k && n || (c[e + t] = -1 === k ? u[0] : u.join(" "), delete c[e + "-top" + t], delete c[e + "-right" + t], delete c[e + "-bottom" + t], delete c[e + "-left" + t])
                                        }
                                    }
                                }
                            }
    ...
    var Fu, Uu = Mu,
        ...
        js = function(e) {
            ...
            if (Ns(e.container()))
                if (e.isAtEnd()) n = Bs(e.container(), e.offset()), Ts(n) && i(n, n.data.length), As(n) && !Ds(n) && o(zs(Us(n), !1));
                else {
    ...
    var Vs, qs, $s = Hs,
        ...
        tc = function(e, t) {
            ...
            return Xs(a) ? n = function(e, t) {
                for (;
                    (e = e.previousSibling) && Xs(e);) t += e.data.length;
                return t
            ...
            return {
                show: function(t, e) {
                    ...
                    if (!a(e)) return u = function(e, t) {
                        var n, r = e.ownerDocument.createTextNode(fo),
                            o = e.parentNode;
                        if (t) {
    ...
    var hl, vl = Vn,
        ...
        nf = function(e, t, n) {
            ...
            if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType)
                for (u < (i = s.childNodes).length ? (s = i[u], r = new Xr(s, e.getParent(s, e.isBlock))) : (s = i[i.length - 1], (r = new Xr(s, e.getParent(s, e.isBlock))).next(!0)), o = r.current(); o; o = r.next())
        ...
        Af = function(t, e, n, r) {
            ...
            if (e[0].wrapper || (i = a.getParent(n, e[0].block, u)), i || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(In(n) ? n.parentNode : n, function(e) {
                    return e !== u && wf(t, e)
                }, o)), i && e[0].wrapper && (i = bf(a, i, "ul,ol").reverse()[0] || i), !i)
    ...
    var Wf, Kf, Xf, Yf = (Wf = Ut, Kf = "text", {
        ...
        td = function(u) {
            ...
            return {
                ...
                getAll: function(e) {
                    var t, n, r, o, i, a = (t = u, n = e, r = At.fromDom(t.getBody()), o = Gu(r, "[" + Qu() + '="' + n + '"]'), i = {}, W(o, function(e) {
                        var t = Gn(e, Zu()),
    ...
    var Sd, Nd, Ed, kd, _d, Ad = (Sd = "height", Nd = function(e) {
        ...
        Dd = function(e) {
            var t, n, r, o = At.fromDom(document),
                i = wn(o),
    ...
    var rp, op, ip = np,
        ...
        Cg = function(t, n, e, r) {
            void 0 === r && (r = !0);
            var o, i, a = gg(n, t.getBody(), e.dom),
        ...
        Kg = function(e, t) {
            var n, r, o, i, a, u = At.fromDom(e.selection.getStart(!0)),
                s = Ff(e);
    ...
    var Ah = kt.each,
        ...
        Yh = function(s, c, l, e, f) {
            var t, d = s.formatter.get(c),
                ...
                n = s.selection,
                u = function(e) {
                    var n, t, r, o, i, a, u = (t = e, r = c, o = l, i = f, W(mf((n = s).dom, t.parentNode).reverse(), function(e) {
                        var t;
            ...
            if (e) tf(e) ? ((t = a.createRng()).setStartBefore(e), t.setEndAfter(e), r(t)) : r(e);
            else if ("false" !== a.getContentEditable(n.getNode())) n.isCollapsed() && m.inline && !Ff(s).length ? xh(s, c, l, f) : ($f(n, !0, function() {
                qf(s, r)
            }), m.inline && jm(s, c, l, n.getStart()) && nf(a, n, n.getRng()), s.nodeChanged());
            else {
                e = n.getNode();
        ...
        gv = function(e, t) {
            var n, r = At.fromDom(t.commonAncestorContainer),
                o = Dp(r, e),
                i = H(o, function(e) {
                    return to(e) || Zr(e)
                }),
        ...
        Sv = function(e, t, n) {
            ...
            n.getInner = !0;
            var r, o, i, a, u, s, c, l = (o = n, i = (r = e).selection.getRng(), a = r.dom.create("body"), u = r.selection.getSel(), s = Om(r, Lf(u)), (c = o.contextual ? bv(At.fromDom(r.getBody()), s).dom : i.cloneContents()) && a.appendChild(c), r.selection.serializer.serialize(a, o));
                    ...
                    canApply: function(e) {
                        return function(e, t) {
                            var n, r, o, i, a, u = e.formatter.get(t),
                                s = e.dom;
                            if (u)
                                for (n = e.selection.getStart(), r = mf(s, n), i = u.length - 1; 0 <= i; i--) {
                ...
                v = {
                    ...
                    getSelectedBlocks: function(e, t) {
                        return function(e, t, n, r) {
                            var o, i = [],
                                a = e.getRoot();
                            if (n = e.getParent(n || Rm(a, t, t.collapsed), e.isBlock), r = e.getParent(r || Tm(a, t, t.collapsed), e.isBlock), n && n !== a && i.push(n), n && r && n !== r)
                                for (var u = new Xr(o = n, a);
    ...
    var sy, cy, ly = function(e, t, n, r) {
        ...
        Cy = function(e, t, n) {
            return o = n, (r = e) && r.hasEventListeners("PreProcess") && !o.no_events ? function(e, t, n) {
                ...
                }), t = "BODY" !== t.nodeName ? r.body.firstChild : r.body, o = i.doc, i.doc = r), a = e, u = ke(ke({}, n), {
                    node: t
        ...
        xy = function(e, t, n, r, o) {
            ...
            return a = e, s = f, (u = o).no_events || !a ? s : (c = a, l = ke(ke({}, u), {
                content: s
        ...
        qy = function(e, t, n, r) {
            var o, i, a, u = Uy(n.forced_plugins),
                s = Uy(r.plugins),
    ...
    var ub = function(n) {
        ...
        pb = function(t) {
            var e, n, r = (n = (e = t).getParam("content_css"), q(n) ? z(n.split(","), $e) : S(n) ? n : !1 === n || e.inline ? [] : ["default"]),
    ...
    var Cb, wb, xb = kt.each,
        ...
        kb = function(n, e) {
            ...
            var c, l = (c = e.selector) && "string" == typeof c ? (c = (c = c.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), kt.map(c.split(/(?:>|\s+(?![^\[\]]+\]))/), function(e) {
        ...
        pw = function(n, r, i, o) {
            var e, t, a = (e = n.getBody(), t = o.container(), rl(t, e) || e),
                u = N(Ib, n),
                s = WC(u, a, o);
    ...
    var Gw = function(o, i, a, e, u, t) {
        ...
        cx = function(e, t, n) {
            var r, o, i = Yw(H(oe(e.getElementsByTagName("*")), Kc)),
                a = H(i, N(ax, n));
            if (u = ux(a, t)) {
        ...
        mx = function(t, e, n, r, o, i) {
            var a = dl(e, t.getBody(), n),
                ...
                s = e === Mw.Down;
            if (!u) return U.none();
            var c, l = (s ? Qw : Jw)(t.getBody(), Zw(1), a),
                f = H(l, ex(1)),
                d = u.left,
                m = ux(f, d);
            if (m && i(m.node)) {
        ...
        Ax = function(t, n) {
            var e, r, o = At.fromDom(t.getBody()),
        ...
        SS = function(e, t) {
            var n, r, o, i = (r = N(Ib, n = e), o = $s.fromRangeStart(n.selection.getRng()), WC(r, n.getBody(), o).filter(wS));
        ...
        WS = function(e) {
            var t, n, r = $s.fromRangeStart(e.selection.getRng()),
        ...
        rk = ke(ke({}, gE), {
            ...
            remove: function(e) {
                ...
                if (e) {
                    ...
                    for (t = QE.length - 1; 0 <= t; t--) r.remove(QE[t])
            },
    ...
    vk.extend = ak = function(n) {
        var o = this.prototype,
            r = function() {
                var e, t, n;
                if (!uk && (this.init && this.init.apply(this, arguments), t = this.Mixins))
    ...
    var Rk, Tk = {
        ...
        Dk = kt.extend(rk, Tk);
    Rk = Dk, window.tinymce = Rk, window.tinyMCE = Rk,
        function(e) {
