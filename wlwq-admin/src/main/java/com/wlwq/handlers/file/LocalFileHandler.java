 ...
 *  @Description: Local file handler.
 */
@Slf4j
@Component
public class LocalFileHandler implements FileHandler {
    ...
    //TODO 本地上传路径
//    private final String workDir = "D:/wlwq/uploadPath";
    //服务器上传路径
    //private final String workDir = "/mnt/uploadPath";
...
//        if ("pro,druid-pro".equals(this.springProfilesActive)) {
...
//        return "/mnt/uploadPath";
    ...
    public LocalFileHandler(IOptionsService optionService) {
...
//        workDir = "/";
    ...
    public @NotNull UploadResult upload(MultipartFile file) {
        ...
        String subDir = UPLOAD_SUB_DIR + year + FILE_SEPARATOR + monthString + FILE_SEPARATOR + day + FILE_SEPARATOR;

        String originalBasename = FilenameUtils.getBasename(Objects.requireNonNull(file.getOriginalFilename()));

        // Get basename
        //String basename = originalBasename + '-' + IdUtils.randomUUIDWithoutDash();
        String basename = IdUtils.randomUUIDWithoutDash();
