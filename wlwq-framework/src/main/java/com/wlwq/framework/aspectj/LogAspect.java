package com.wlwq.framework.aspectj;
...
import com.wlwq.common.enums.BusinessStatus;
import com.wlwq.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.wlwq.common.annotation.Log)")
