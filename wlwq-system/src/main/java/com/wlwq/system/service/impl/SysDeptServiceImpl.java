...
import com.wlwq.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
    ...
    public List<SysDept> selectApiDeptList(SysDept dept) {
        return deptMapper.selectApiDeptList(dept);
    }
    ...
    public SysDept selectApiNearbyCity(SysDept dept) {
        return deptMapper.selectApiNearbyCity(dept);
    }
     ...
     */
    @Override
    public List<HashMap<String, Object>> selectDeptMap(Long companyId) {
        return deptMapper.selectDeptMap(companyId);
    }
     ...
     */
    @Override
    public List<HashMap<String, Object>> selectDeptAndAccountMap(Long companyId) {
        return deptMapper.selectDeptAndAccountMap(companyId);
    }
    ...
    public SysDept selectDeptByDeptId(Long deptId) {
        ...
        if (sysDept != null) {
            ...
            selectDeptByDeptId(sysDept.getParentId());
        }
        return null;
    }
    ...
    public Map<String,Object> selectClock(SysDept dept){
        return deptMapper.selectClock(dept);
    }
    /**
     * 查询本公司的人
     * @param sysDept
    ...
    @Override
    @DataScope(deptAlias = "d")
    public List<Ztree> treeDataByCompany(SysDept sysDept) {
       // List<SysDept> deptList = deptMapper.treeDataByCompany(sysDept);
