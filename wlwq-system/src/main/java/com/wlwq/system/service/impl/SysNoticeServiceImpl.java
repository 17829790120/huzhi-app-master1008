...
import com.wlwq.system.mapper.SysNoticeMapper;
...
public class SysNoticeServiceImpl implements ISysNoticeService {
    ...
    public int insertNotice(SysNotice notice) {
        notice.setNoticeId(IdUtil.getSnowflake(1, 1).nextIdStr());
     ...
     */
    @Override
    public List<SysNotice> selectApiNoticeList(SysNotice notice) {
        return noticeMapper.selectApiNoticeList(notice);
    }
}
