 ...
 * @date 2023-05-18
 */
public interface CounsellingTheoreticalPostMapper {
    /**
     * 查询理论体系资讯
     *
     ...
     * 批量删除理论体系资讯
     *
     * @param counsellingTheoreticalPostIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteCounsellingTheoreticalPostByIds(String[] counsellingTheoreticalPostIds);
}
