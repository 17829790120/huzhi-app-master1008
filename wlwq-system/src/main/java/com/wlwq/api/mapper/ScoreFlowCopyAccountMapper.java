 ...
 * @date 2023-06-07
 */
public interface ScoreFlowCopyAccountMapper {
    /**
     * 查询用户积分审批抄送流程
     *
     ...
     * 批量删除用户积分审批抄送流程
     *
     * @param scoreFlowCopyAccountIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteScoreFlowCopyAccountByIds(String[] scoreFlowCopyAccountIds);
