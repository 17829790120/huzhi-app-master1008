...
/**
 * 理论体系资讯对象 counselling_theoretical_post
 *
 * @author wwb
 * @date 2023-05-18
 */
...
@NoArgsConstructor
@Builder
@Alias("CounsellingTheoreticalPost")
public class CounsellingTheoreticalPost extends BaseEntity {
     ...
     * 理论体系资讯ID
     */
    private String counsellingTheoreticalPostId;
